...
export default class HomePage extends qPage {
    ...
    rendItem(post: any, index: number) {
        return <q-card>
                    ...
                    <q-image hero="{'top': 0, 'width': '100%', 'left': 0}" className="mainimage" slot="img" srcimg={ (post.backdrop_path)?'http://image.tmdb.org/t/p/w500' + post.backdrop_path:'https://via.placeholder.com/500x281' }>
