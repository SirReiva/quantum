...
class mylist extends QuantumElement {
    template() {
        return h(
            ...
            h(
                'mat-button',
                { ref: 'btnUpdate', onclick: e => this.updateOne(e) },
                'Render One '
            ),
            h(
                'ul',
...
class matappbar extends QuantumElement {
    template() {
        return h(
            'div',
            { 'class': 'nav' },
            h('input', { type: 'checkbox', id: 'nav-check' }),
            h(
                'div',
                { 'class': 'nav-header' },
                h(
            ...
            h(
                ...
                h(
                    'a',
                    { href: '//github.io/jo_geek', target: '_blank' },
                    'Github'
                ),
                h(
                    'a',
                    { href: 'http://stackoverflow.com/users/4084003/', target: '_blank' },
                    'Stackoverflow'
                ),
                h(
                    'a',
                    { href: 'https://in.linkedin.com/in/jonesvinothjoseph', target: '_blank' },
                    'LinkedIn'
                ),
                h(
                    'a',
                    { href: 'https://codepen.io/jo_Geek/', target: '_blank' },
                    'Codepen'
                ),
                h(
                    'a',
                    { href: 'https://jsfiddle.net/user/jo_Geek/', target: '_blank' },
                    'JsFiddle'
                )
            )
        );
